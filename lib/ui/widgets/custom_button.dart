...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({
    ...
    this.width= 248.0,
    this.height=44.0,
    this.borderColor =  ConstantsColors.transparent,
    this.shadowColor,
    this.overlayColor,
  })  : child = null,
        gapLeadingText = null,
  ...
  const CustomButton.icon({
    ...
    this.height=44.0,
    this.overlayColor,
  }) :this.borderColor=ConstantsColors.transparent, super(key: key);
    ...
    return SizedBox(
      ...
      child: TextButton(
        ...
        style:Theme.of(context).elevatedButtonTheme.style!.copyWith(
            ...
            shadowColor: MaterialStateProperty.all(shadowColor??ConstantsColors.shadowColor),
          backgroundColor: MaterialStateProperty.all(color??ConstantsColors.primaryColor),
          shape:  MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular((radius??8).r), side: BorderSide(color: borderColor)))
        ),
        child: child == null
            ? CustomText(
                text: text,
